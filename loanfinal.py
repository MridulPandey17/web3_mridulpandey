...
class loan:
    lendmoneypool1=0
    lendmoneypool2=0   #for lenders there is a loan pool for aech group, so borrowers can lend money only as long as they are within the lender pool of that particular group.
    lendmoneypool3=0
    lendmoneypool4=0
...
""")
    ...
    def __case1(self):
        ...
        if loan.lendmoneypool1>prin:
            print("Please collect your money from the cash counter \nloan category l1 \nThank you for your time")
            loan.lendmoneypool1=loan.lendmoneypool1-prin
        else:
            print("NOt enough money available, sorry")
    ...
    def __case2(self):
        ...
        if loan.lendmoneypool2>prin:
            print("Please collect your money from the cash counter \nloan category l2 \nThank you for your time")
            loan.lendmoneypool2=loan.lendmoneypool2-prin
        else:
            print("NOt enough money available, sorry")
    ...
    def __case3(self):
        ...
        time=self.timeduration
        self.totaldueborrower= prin+ prin*(1+(intrb/(1200))**time) 
        if loan.lendmoneypool3>prin:
            print("Please collect your money from the cash counter \nloan category l3 \nThank you for your time")
            loan.lendmoneypool3=loan.lendmoneypool3-prin
        else:
            print("NOt enough money available, sorry")
    ...
    def __case4(self):
        ...
        time=self.timeduration
        self.totaldueborrower= prin+ prin*(1+(intrb/(1200))**time) 
        if loan.lendmoneypool4>prin:
            print("Please collect your money from the cash counter \nloan category l4 \nThank you for your time")
            loan.lendmoneypool4=loan.lendmoneypool4-prin
        else:
            print("NOt enough money available, sorry")
...
""")
    ...
    def __casel1(self):
        ...
        loan.lendmoneypool1=loan.lendmoneypool1+prinl
    ...
    def __casel2(self):
        ...
        self.timeduration=int(input("Please enter the number of months for which you want to lend the money"))
        timel= self.timeduration
        loan.lendmoneypool2=loan.lendmoneypool2+prinl
    ...
    def __casel3(self):
        ...
        self.timeduration=int(input("Please enter the number of months for which you want to lend the money"))
        timel= self.timeduration
        loan.lendmoneypool3=loan.lendmoneypool3+prinl
    ...
    def __casel4(self):
        ...
        self.timeduration=int(input("Please enter the number of months for which you want to lend the money"))
        timel= self.timeduration
        loan.lendmoneypool4=loan.lendmoneypool4+prinl
